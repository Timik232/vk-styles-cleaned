...
### Fixed
- Совмещены оба требования для боковой панели: сохранён скруглённый вид и возвращено правое позиционирование в mini+fix режиме (`mm.mb`)
...
### Fixed
- Исправлено позиционирование мини-боковой панели: в режиме mini она снова прижимается вправо (включая режим «Фикс»)
...
### Fixed
- Исправлен внешний вид фиксированной боковой панели: убрана квадратная подложка после клипа, обрезка обводки перенесена на внутренний контейнер меню
